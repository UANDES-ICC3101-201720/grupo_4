...
namespace Entrega_2_Proyecto_POO
{
    public class Simular
    {
        ...
        public List<string> StoresNames = new List<string> { };
        ...
        public void CrearPisos(int Cantidad, List<int> Area)
        {
            for (int i = 1; i <= Cantidad; i++)
            {
                ...
                AllFloors.Add(piso);
                Console.WriteLine("Ingrese la cantidad de tiendas para este piso");
                int CantidadTiendas = Convert.ToInt32(Console.ReadLine());
                CrearLocalesPorPiso(CantidadTiendas, piso);
            }
        }
        public void CrearLocalesPorPiso(int Cantidad, Piso piso)
        {
            for (int i=1; i<=Cantidad; i++)
            {
                ...
                if (Tipo[aux] == "Comercial")
                {
                    ...
                    {
                        Console.WriteLine("Supera el Area Maxima");
                    }
                }
